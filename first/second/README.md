...
양식을 제출한다. 글 쓰는 거, 설문조사

1. 인풋차 입력하고 Enter 했을 때 작동하면 양식: 폼
...
2. label 태그와 연결가능
   - label의 for 값과 input의 값을 같게 주면 됨
...
2. option 태그와 사용함
   ...
   - option을 선택할 떄 보이는 글자가 아니라 option 태그 안의 value 값을 받아옴
...
- 중복되게 부여하다면 마지막 옵션을 선택해줌

## 제출버튼

1.  button
    type 속성의 기본값이 submit임 **form 태그안에서만 됨**
